...
export const visualizationConfig: Record<VisualizationType, {
  ...
  'projectile-motion': { durationInFrames: 180, fps: 30, width: 800, height: 500 },
  ...
  'solar-system': { durationInFrames: 360, fps: 30, width: 800, height: 500 },
  'atom': { durationInFrames: 180, fps: 30, width: 800, height: 500 },
  'circuits': { durationInFrames: 120, fps: 30, width: 800, height: 500 },
}
